...
document.getElementById("btnPlay").addEventListener("click", function(){ tl.play(); animTl.play() });
document.getElementById("btnPause").addEventListener("click", function(){ tl.pause();animTl.pause();});
document.getElementById("btnResume").addEventListener("click", function(){ tl.resume();animTl.resume();});
document.getElementById("btnReverse").addEventListener("click", function(){ tl.reverse();animTl.reverse();});
document.getElementById("btnSlowDown").addEventListener("click", function(){ tl.timeScale(0.5);animTl.timeScale(0.5);});
document.getElementById("btnSpeedUp").addEventListener("click", function(){ tl.timeScale(5);animTl.timeScale(5);});
...
let tween1 = (TweenLite.to(bb8Head, 1, {rotation: 30, x: 240, y: 130, transformOrigin: "center", ease:new SlowMo(0.5, 0.8), yoyo: true}))
let tween2 = (TweenLite.to(bb8Head, 1, {rotation: 0, x: 10, y: 0, transformOrigin: "center", ease: Power3.easeInOut, yoyo: true,}))
let tween3 =(TweenLite.to(bb8Head, 1, {rotation: -20, x: -200, y: 30, transformOrigin: "center", ease: Bounce.easeOut, yoyo: true,}))
let tween4 = (TweenLite.to(bb8Head, 1, {rotation: 0, x: 10, y: 0, transformOrigin: "center", ease: Power3.easeInOut, yoyo: true,}))
